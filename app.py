    ...
    def convert_format(self, output_format, quality="medium"):
        ...
        try:
            if output_format not in SUPPORTED_OUTPUT_FORMATS:
                raise ValueError(
                    f"Unsupported output format. Supported: {SUPPORTED_OUTPUT_FORMATS}"
                )
...
def download_video_from_url(url):
    ...
    try:
        ...
        if not any(video_type in content_type for video_type in video_types):
...
<body>
    <div class="container">
        <div class="card">
            ...
            <p class="subtitle">A Simple Video Processing Microservice</p>
            
            <div class="description">
                <p>FFmpeg Service is a Flask-based microservice that provides powerful video processing capabilities. The service supports video format conversion, screenshot extraction, video information analysis, and offers developers an easy-to-use video processing API.</p>
            </div>

            <div class="features">
                <div class="feature">
                    <h3>🎬 Video Processing</h3>
                    <p>Supports conversion and processing of multiple video formats, including popular formats such as MP4, AVI, MOV, MKV, and more.</p>
                </div>
                <div class="feature">
                    <h3>📸 Screenshot Feature</h3>
                    <p>Automatically extracts video screenshots, supports specifying timestamps or evenly distributed screenshots, making video preview convenient.</p>
                </div>
                <div class="feature">
                    <h3>📊 Information Analysis</h3>
                    <p>Extracts detailed video metadata, including resolution, frame rate, duration, codec, and more.</p>
                </div>
                <div class="feature">
                    <h3>🔒 Secure Authentication</h3>
                    <p>Supports API Key authentication to ensure service security and reliability, suitable for production environments.</p>
                </div>
            </div>
            ...
            <div class="api-info">
                <h3>API Endpoints</h3>
                <ul>
                    <li><strong>POST /process</strong> - Main video processing endpoint</li>
                    <li><strong>POST /info</strong> - Get video information</li>
                    <li><strong>GET /download/&lt;filename&gt;</strong> - Download processed files</li>
        ...
        <div class="card">
            <div class="footer">
                <p><strong>Open Source Project</strong> | <a href="https://github.com/funnyzak/ffmpeg-service" target="_blank">GitHub</a></p>
                <p>Author: <a href="https://github.com/funnyzak" target="_blank">@funnyzak</a></p>
                <p>Built with Flask + FFmpeg</p>
            </div>
        </div>
    </div>
</body>
...
def get_video_info():
    ...
    try:
        ...
        cleanup_temp_files(*temp_files)
        return (
            create_response(code=500, msg=f"Failed to extract video info: {str(e)}"),
            500,
        )
